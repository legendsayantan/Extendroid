...
object MapKeyEvent {
    ...
    fun buildKeyEvent(downTime:Long, eventTime:Long, action:Int, webKeyCode:Int, metaState:Int): KeyEvent? {
        return when(webKeyCode){
            ...
            -8 -> KeyEvent(downTime, eventTime, action,KeyEvent.KEYCODE_VOLUME_MUTE,0, metaState)
            -9 -> KeyEvent(downTime, eventTime, action,KeyEvent.KEYCODE_VOLUME_UP,0, metaState)
